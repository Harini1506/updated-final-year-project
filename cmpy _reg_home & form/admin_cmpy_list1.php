...
<head>
    ...
    .company-list {
        ...
        .activate-button {
            margin-right: 10px; /* Add margin or padding here */
        }
    </style>
</head>
<body>
    ...
    <div class="company-list">
        <div class="container">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<a href="#" class="job-control-button activate-button">Activate</a>';
                echo '<a href="#" class="job-control-button deactivate-button">Deactivate</a>';
                echo '</div>';
                echo '</div>';
                echo '</div>';
            }
